...
describe('create-story', () => {
  ...
  it('creates new story', async () => {
    ...
    try {
      ...
      expect(json.data).toEqual({ id: expect.any(String), slug: expect.stringContaining('my-first-story') });
      ...
      expect(duplicateJson.data).toEqual({ id: expect.any(String), slug: expect.stringContaining('my-first-story') });
    } finally {
      await server.close();
    }
  });
